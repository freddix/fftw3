...
%post	single	-p /usr/sbin/ldconfig
%postun	single	-p /usr/sbin/ldconfig

%post	long	-p /usr/sbin/ldconfig
%postun	long	-p /usr/sbin/ldconfig

%post	common-devel -p	/usr/sbin/postshell
-/usr/sbin/fix-info-dir -c %{_infodir}

%postun	common-devel -p	/usr/sbin/postshell
-/usr/sbin/fix-info-dir -c %{_infodir}
